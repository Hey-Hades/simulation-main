...
pygame.display.set_caption("Enchanted Forest Gravity Bounce")
...
# =====================================================
# COLORS (Enchanted Forest Aesthetic)
# =====================================================
BG = (8, 18, 12)              # Dark pine abyss
MAIN_TEXT = (220, 250, 210)   # Pale matcha 
SUB_TEXT = (90, 140, 100)     # Dim sage
HIGHLIGHT = (120, 255, 150)   # Bright mint 

STRIPE_COLORS = [
    (0, 50, 20, 255),      # Deep Jungle Green
    (34, 139, 34, 255),    # Forest Green
    (46, 204, 113, 255),   # Emerald
    (173, 255, 47, 255),   # Yellow Green
    (212, 255, 120, 255),  # Soft Mint
]
...
def color_from_hue(hue):
    ...
    restricted_hue = 80 + (hue % 60)
    color.hsla = (restricted_hue, 85, 55, 100)
    return color
...
while running:
    ...
    # --- UI RENDERING ---
    hook_text = hook_font.render("WILL IT FILL 100%?", True, MAIN_TEXT)
