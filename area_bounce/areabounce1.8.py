...
pygame.display.set_caption("Hazard Warning Paint Bounce")
...
# COLORS & FONTS
# =====================================================
# Hazard Warning Palette
PAINT_COLOR = (10, 10, 12)      # Pitch Black (Void/Paint)
ARENA_COLOR = (255, 220, 0)     # Cyber Yellow (Arena)
...
while running:
    ...
    hook_text = hook_font.render(
        ...
        True,
       (245, 245, 245) # Blinding cyber yellow text
    )
    ...
    part2 = watermark_font.render("C u l t", True, (255, 210, 70))     # Aggressive Alert Red accent
