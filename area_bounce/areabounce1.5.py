...
pygame.display.set_caption("Monochrome Mint Paint Bounce")
...
# COLORS & FONTS
# =====================================================
# Monochrome Mint Palette
PAINT_COLOR = (20, 35, 35)      # Dark Slate (Void/Paint)
ARENA_COLOR = (150, 255, 200)   # Bright Mint (Arena)
...
while running:
    ...
    hook_text = hook_font.render(
        ...
        True,
        ARENA_COLOR  # Matches the chalky mint arena
    )
    ...
    part2 = watermark_font.render("C u l t", True, (220, 255, 240))     # Pale, icy mint accent
