...
pygame.display.set_caption("Vaporwave Sunset Gravity Bounce")
...
# =====================================================
# COLORS (Vaporwave Sunset Aesthetic)
# =====================================================
BG = (15, 5, 25)              # Deep violet night
MAIN_TEXT = (255, 230, 200)   # Warm peach
SUB_TEXT = (150, 80, 120)     # Dim magenta
HIGHLIGHT = (255, 80, 120)    # Neon coral

STRIPE_COLORS = [
    (75, 0, 130, 255),     # Deep Purple
...
def color_from_hue(hue):
    ...
    restricted_hue = 270 + (hue % 120) 
    color.hsla = (restricted_hue % 360, 95, 60, 100)
    return color
