...
pygame.display.set_caption("Ethereal Ice Paint Bounce")
...
# COLORS & FONTS
# =====================================================
# Ethereal Ice Palette
PAINT_COLOR = (10, 20, 35)      # Midnight Blue (Void/Paint)
ARENA_COLOR = (200, 240, 255)   # Ice Blue (Arena)
...
while running:
    ...
    hook_text = hook_font.render(
        ...
        True,
        ARENA_COLOR  # Matches the crisp Ice Blue arena
    )
    ...
    part2 = watermark_font.render("C u l t", True, (150, 255, 255))     # Bright, frosty cyan accent
