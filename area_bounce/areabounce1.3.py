...
pygame.display.set_caption("Matcha & Cream Paint Bounce")
...
# COLORS & FONTS
# =====================================================
# Matcha & Cream Palette
PAINT_COLOR = (44, 75, 60)    # Forest Green (Void/Paint)
ARENA_COLOR = (250, 243, 224) # Warm Cream (Arena)
...
while running:
    ...
    hook_text = hook_font.render(
        ...
        True,
        ARENA_COLOR  # Adapted to match the cream arena
    )
    ...
    bounces_text = counter_font.render(f"Bounces: {collision_count}", True, ARENA_COLOR) # Adapted to match the cream arena
    ...
    part1 = watermark_font.render("@ B o u n c e ", True, ARENA_COLOR) # Adapted to match the cream arena
    part2 = watermark_font.render("C u l t", True, (255, 210, 70))     # Left yellow as a highlight
