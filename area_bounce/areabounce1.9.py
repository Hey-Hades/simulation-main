...
# Updated caption to reflect the new colors
pygame.display.set_caption("Dark & Neon Paint Bounce")
...
PAINT_COLOR = (17, 17, 17)    # Dark / Void
ARENA_COLOR = (198, 255, 0)   # Neon Yellow-Green
...
while running:
    ...
    # --- DYNAMIC HOOK TEXT ---
    prefix_text = font_small_text.render("Will this video get me ", True, (255, 255, 255))
    
    if collision_count == 0:
        k_text = font_large_text.render("? ", True, (232, 192, 81)) 
    else:
        k_text = font_large_text.render(f"{collision_count}", True, (232, 192, 81)) 
