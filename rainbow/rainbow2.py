...
pygame.display.set_caption("Bioluminescent Paint Fill Bounce")
...
# =====================================================
# COLORS (Bioluminescent / Toxic Slime Aesthetic)
# =====================================================
BG = (5, 12, 8)            # Deep murky green-black
WHITE = (150, 255, 150)    # Pale Mint (for text)
...
# Acid Greens and Cyans
STRIPE_COLORS = [
    (180, 255, 0, 255),    # Acid Yellow-Green
    (100, 255, 0, 255),    # Lime
    (0, 255, 60, 255),     # Neon Green
    (0, 255, 170, 255),    # Mint/Teal
    (0, 220, 255, 255),    # Cyan
]
...
def color_from_hue(hue):
    ...
    # Restricted the hue to between 80 (Lime) and 180 (Cyan) to match the theme
    restricted_hue = 80 + (hue % 100) 
    color.hsla = (restricted_hue, 100, 50, 100)
    return color
