...
pygame.display.set_caption("Obsidian & Gold Paint Fill Bounce")
...
# =====================================================
# COLORS (Obsidian & Gold Aesthetic)
# =====================================================
BG = (12, 12, 14)          # Near-black Obsidian
WHITE = (255, 240, 200)    # Soft glowing gold (for text)
...
# Bronze, Rich Gold, and White Gold
STRIPE_COLORS = [
    (139, 101, 8, 255),    # Dark Bronze
    (184, 134, 11, 255),   # Rich Antique Gold
    (218, 165, 32, 255),   # Bright Gold
    (255, 215, 0, 255),    # Pure Golden Yellow
    (255, 250, 205, 255),  # Shimmering White Gold
]
...
def color_from_hue(hue):
    ...
    # Restricted hue between 35 and 50 to lock into the golden yellow spectrum
    restricted_hue = 35 + (hue % 15)
    color.hsla = (restricted_hue, 95, 55, 100)
    return color
