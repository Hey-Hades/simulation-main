...
pygame.display.set_caption("Ember Paint Fill Bounce")
...
# =====================================================
# COLORS (Ember Glow Aesthetic)
# =====================================================
BG = (15, 5, 5)            # Deep dark maroon
WHITE = (255, 215, 0)      # Golden Yellow (for text)
...
# Fiery Sunset Stripes
STRIPE_COLORS = [
    (255, 30, 0, 255),     # Vivid Red
    (255, 90, 0, 255),     # Red-Orange
    (255, 140, 0, 255),    # Orange
    (255, 180, 0, 255),    # Golden Orange
    (255, 215, 0, 255),    # Gold
]
...
def color_from_hue(hue):
    ...
    # Kept highly saturated but shifted slightly warmer for the ember vibe
    color.hsla = (hue % 360, 95, 55, 100)
    return color
