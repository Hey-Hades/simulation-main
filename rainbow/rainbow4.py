...
pygame.display.set_caption("Neon Paint Fill Bounce")
...
# =====================================================
BG = (13, 2, 33)           # Deep dark purple
WHITE = (0, 255, 204)      # Neon Cyan (for text)
...
# Synthwave Neon Stripes
STRIPE_COLORS = [
    (255, 0, 128, 255),    # Neon Pink
    (217, 0, 255, 255),    # Magenta
    (112, 0, 255, 255),    # Deep Purple
    (0, 102, 255, 255),    # Electric Blue
    (0, 255, 204, 255),    # Cyan
]
