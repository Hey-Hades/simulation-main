...
# =====================================================
# DYNAMIC COLOR PROFILE STATES (Morphs Over Time)
# =====================================================
# Phase 1 Colors (0% - 50% Time): Calm Zen Sage
START_BG_COLOR     = (244, 241, 234)
START_CIRCLE_COLOR = (91, 114, 101)
START_LINE_COLOR   = (201, 196, 180)
START_BALL_COLOR   = (214, 110, 81)

# Phase 2 Colors (50% - 100% Time): Suspenseful High-Contrast Charcoal
END_BG_COLOR       = (247, 245, 238)
END_CIRCLE_COLOR   = (34, 38, 41)
END_LINE_COLOR     = (186, 193, 184)
END_BALL_COLOR     = (224, 153, 36)

ACCENT_GOLD        = (212, 175, 55)

# Run-time active colors initialized
BG_COLOR     = START_BG_COLOR
CIRCLE_COLOR = START_CIRCLE_COLOR
LINE_COLOR   = START_LINE_COLOR
BALL_COLOR   = START_BALL_COLOR
...
while running:
    ...
    if game_state == "PLAYING":
        ...
        # Smoothly shift colors across the lifetime of the video
        BG_COLOR     = lerp_color(START_BG_COLOR, END_BG_COLOR, progress)
        CIRCLE_COLOR = lerp_color(START_CIRCLE_COLOR, END_CIRCLE_COLOR, progress)
        LINE_COLOR   = lerp_color(START_LINE_COLOR, END_LINE_COLOR, progress)
        BALL_COLOR   = lerp_color(START_BALL_COLOR, END_BALL_COLOR, progress)
    ...
    if game_state == "PLAYING":
        ...
        part2 = watermark_font.render("C u l t", True, ACCENT_GOLD) 
